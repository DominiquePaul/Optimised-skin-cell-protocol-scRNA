...
## Library size vs. mito share by sample {.tabset}

```{r lib size vs. mito, fig.width=16, fig.height=10, results="asis"}
cat(paste0("\n\n### Fresh samples only \n\n"))
...
## Mito. percent vs. genes by sample {.tabset}
...
```{r geme counts by protocol, fig.width=16, fig.height=10}
sce_all[, !sce_all$to_be_dropped] %>% 
  ggplot() +
  theme_ipsum_rc() +
  labs(title="Distribution of gene counts",
...
## Show cluster to sample mapping {.tabset}
...
```{r cluster to sample assignment, fig.width=5, fig.height=7, results="asis"}
