...
```{r load-data}
sce <- readRDS(file="../data/fresh_data/protocol_integration_analysis_sce_EOS3.rds")
...
saveRDS(sce, file = "../data/fresh_data/protocol_integration_analysis_sce_EOS4.rds")
```
