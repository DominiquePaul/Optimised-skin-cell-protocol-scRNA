...
```{r load-data}
sce <- readRDS(file="../data/fresh_data/Protocol2_All_sce_EOS1.rds")
# sce <- readRDS(file="../data/fresh_data/Protocol2_All_sce_EOS4.rds")

# sce$Sample <- sub("Skin_S1", "Culture_S1", sce$Sample)
# sce$Sample <- sub("Skin_S2", "Culture_S2", sce$Sample)
# sce$Sample <- sub("Skin_S4", "Culture_S4", sce$Sample)
# sce$Sample <- sub("Skin_S5", "Culture_S5", sce$Sample)
# sce$Sample <- factor(sce$Sample)
# 
# sce$Protocol <- sub("SSc", "Culture", sce$Protocol)
# sce$Protocol <- factor(sce$Protocol, levels=c("Fresh", "Culture"))
# # 
# saveRDS(sce, file="../data/fresh_data/Protocol2_All_sce_EOS1.rds")
```
...
```{r figure 9.2, fig.width=10, fig.height=12}
...
saveRDS(sce, "../data/fresh_data/Protocol2_All_sce_EOS4.rds")
```
