...
```{r Fresh vs. Tabib}
res_fresh_lafa <- glmQLFTest(fit.ab, contrast = contrast[,"Tabib_et_al-Fresh", drop=FALSE])
...
## Test He et al. vs Fresh

```{r Fresh vs. He}
res_fresh_he_et_al <- glmQLFTest(fit.ab, contrast = contrast[,"He_et_al-Fresh", drop=FALSE])
...
res_fresh_sole_boldo <- glmQLFTest(fit.ab, contrast = contrast[,"Sole_Boldo_et_al-Fresh", drop=FALSE])
